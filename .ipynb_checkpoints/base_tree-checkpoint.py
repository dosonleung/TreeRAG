...
class Node:
    def __init__(self,
        ...
        self.content['value'] = [] #value for global value
...
class DecisionTreeClassifier(BaseEstimator):
    def __init__(self,
        ...
        assert splitter.lower() in ['best','random']
        assert build_method.lower() in ['bfs','dfs']
    ...
    # 输出2：True, 节点内容
    def _split(self, X, Y, min_impurity_decrease=0.0, min_samples_split=2, is_leave=False):
        ...
        if condition1 and condition2 and condition3 and condition4: #become a leaf
